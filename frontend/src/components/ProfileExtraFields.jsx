...
export default function ProfileExtraFields({ form, onChange, disabled = false }) {
  ...
  const diplomaBranches = programs.find(p => p.course === "B.Tech")?.branches || [];
