...
const statusColor = { APPLIED: "text-amber-200 bg-amber-400/10", SELECTED: "text-emerald-200 bg-emerald-400/10", REJECTED: "text-red-200 bg-red-400/10", WITHDRAWN: "text-slate-300 bg-slate-400/10" };
