...
export function newRole() {
  return { title: "", description: "", location: "", experience: "", positions: "", domain: "TECH", jobType: "Full-time", isActive: true, resumeRequired: true,
    ...
    eligibility: { allCourses: false, programs: [], educationRequirement: "TWELFTH_OR_DIPLOMA", minCgpa: 0, minTenthPercentage: "", minTwelfthPercentage: "", minDiplomaPercentage: "", maxActiveBacklogs: 0, maxTotalBacklogs: "", allowActiveBacklogs: false, branches: "", years: "" }, stages: [appliedStage()], lockedStageCount: 0 };
}
