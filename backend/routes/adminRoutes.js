...
router.post("/", validate(z.object({ name, email: z.string().trim().toLowerCase().email().max(254), role: role.default("admin"), permissions: permissions.default([]) }).strict()), addAdmin);
